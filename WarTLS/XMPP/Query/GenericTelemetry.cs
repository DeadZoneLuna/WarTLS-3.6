...
{
    class GenericTelemetry : Stanza
    {
        string Channel;

        public GenericTelemetry(Client User, XmlDocument Packet) : base(User, Packet)
        {
        ...
        internal override void Process()
        {
            ...
            XElement accountElement = new XElement("generic_telemetry");
